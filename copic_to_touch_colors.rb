...
@ink_only = false
ARGV.each do |arg|
  @ink_only |= arg == "inkonly"
  @ink_only |= arg == "onlyink"
end
...
puts "<title>Matching Copic to Touch Twin Colors</title>\n"
puts "</head>\n"
puts "<body>\n"

puts "<h2>Copic colors 2 Touch Twin colors</h2>"
...
puts "<table>\n"
puts "<tr style=\"background-color:#BBEEBB\">"
puts "<td align=\"center\">Copic<br>Name</td>"

puts "<td align=\"center\">Inc</td>"
puts "<td align=\"center\">Copic<br>Color</td>"
puts "<td align=\"center\">Matches<br>Qt.</td>"
puts "<td align=\"center\">Match<br>%</td>"
puts "<td align=\"center\">Touch<br>Color</td>"
puts "<td align=\"center\">Inc</td>"
puts "<td align=\"center\">Touch<br>Name</td>"
puts "</tr>"
